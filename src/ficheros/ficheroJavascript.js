...
const peticion = function(url,id){
    fetch(url, {
        method : 'GET',
        //mode : 'cors',
...
const paintNews = function(news, id){
    ...
    for (let i=0; i <= news.articles.length; i++){
        ...
        if (descripcion != null)
            htmlCode += `<p> ${descripcion} </p><figure class = "link_page" > <a href=${urlNoticia}><img src = images/periodico.png alt="Acceder a la página">  </a></figure> `;
